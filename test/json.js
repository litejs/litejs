...
describe("JSON", function() {
	...
	.test(".mergePatch()", function(assert, mock) {
		var a, b, tests =
		[ {"A":"b"}         , {"A":"c"}                 , {"A":"c"}         , ["/A"], {"/A":"b"}
		, {"B":"b"}         , {"b":"c"}                 , {"B":"b","b":"c"} , ["/b"], {"/b":undef}
		, {"C":"b"}         , {"C":null}                , {}                , ["/C"], {"/C":"b"}
		, {"D":"b"}         , {"D":undef}               , {"D":"b"}         , [], {}
		, {"E":"b"}         , {"b":undef}               , {"E":"b"}         , [], {}
		, {"F":"b","b":"c"} , {"F":null}                , {"b":"c"}         , ["/F"], {"/F":"b"}
		, {"G":["b"]}       , {"G":"c"}                 , {"G":"c"}         , ["/G"], {"/G": ["b"]}
		, {"H":"c"}         , {"H":["b"]}               , {"H":["b"]}       , ["/H"], {"/H":"c"}
		, {"I":{"b":"c"}}   , {"I":{"b":"d","c":null}}  , {"I":{"b":"d"}}   , ["/I/b", "/I"], {"/I/b":"c","/I":{"b":"c"}}
		, {"J":{"b":"c"}}   , {"J":{"b":"c"}}           , {"J":{"b":"c"}}   , [], {}
		, {"K":{"b":1}}     , {"K":{"b":null}}          , {"K":{}}          , ["/K/b", "/K"], {"/K/b":1,"/K":{"b":1}}

		, {"L":{"b":0}}     , {"L":{"b":1}}             , {"L":{"b":1}}     , ["/L/b", "/L"], {"/L/b":0, "/L":{"b":0}}
		, {"M":{"b":0}}     , {"M":{"b":null}}          , {"M":{}}          , ["/M/b", "/M"], {"/M/b":0,"/M":{"b":0}}
		, {"N":{"b":1}}     , {"N":{"b":0}}             , {"N":{"b":0}}     , ["/N/b", "/N"], {"/N/b":1,"/N":{"b":1}}
		, {"O":{"b":1}}     , {"O":{"b":null}}          , {"O":{}}          , ["/O/b", "/O"], {"/O/b":1,"/O":{"b":1}}
		, {"P":{"b":null}}  , {"P":{"b":0}}             , {"P":{"b":0}}     , ["/P/b", "/P"], {"/P/b":null,"/P":{"b":null}}
		, {"Q":{"b":null}}  , {"Q":{"b":1}}             , {"Q":{"b":1}}     , ["/Q/b", "/Q"], {"/Q/b":null,"/Q":{"b":null}}

		, {"R":[{"b":"c"}]} , {"R":[1]}                 , {"R":[1]}         , ["/R"], {"/R": [{"b":"c"}]}
		, {"S":[{"b":"c"}]} , {"S":{"b":"c"}}           , {"S":{"b":"c"}}   , ["/S/b", "/S"], {"/S/b":undef,"/S":[{"b":"c"}]}
		, {"T":{"b":"c"}}   , {"T":[{"b":"c"}]}         , {"T":[{"b":"c"}]} , ["/T/b", "/T"], {"/T/b":"c","/T":{"b":"c"}}
		, ["U","b"]         , ["c","d"]                 , ["c","d"]         , [], {}
		, {"V":"b"}         , ["c"]                     , ["c"]             , ["/V"], {"/V":"b"}
		, {"Q":"foo"}       , null                      , null              , ["/Q"], {"/Q":"foo"}
		...
		function addTest(i, a, b, c, d, e) {
			var changes = []
			, previous = {}
			assert
			.equal(json.mergePatch(json.clone(a), b, changes, previous), c)
			.equal(changes, d)
		...
		for (var x = 0; x < tests.length; ) {
			addTest(x, tests[x++], tests[x++], tests[x++], tests[x++], tests[x++])
		}
